...
```bash
# Clone and install
git clone https://github.com/inceptyon-labs/tenet-dashboard.git
cd tenet-dashboard
npm install
...
Open a [bug report issue](https://github.com/inceptyon-labs/tenet-dashboard/issues/new?template=bug_report.md). Include reproduction steps and your deployment method (Docker or local).

## Requesting Features

Open a [feature request issue](https://github.com/inceptyon-labs/tenet-dashboard/issues/new?template=feature_request.md). Describe the problem you're solving, not just the solution.
